// Syllable bank with high-frequency 2-3 letter combinations guaranteed to have many English word matches
...
/**
 * Generates a random syllable from the bank
 */
export function generateSyllable(): string {
